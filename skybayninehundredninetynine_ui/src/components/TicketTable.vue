...
<template>
  ...
  <base-input label="SeatNumber" type="text" placeholder="Enter SeatNumber" v-model="ticketToAdd.seatNumber"></base-input>
  <base-input label="Price" type="text" placeholder="Enter Price" v-model="ticketToAdd.price"></base-input>
                  </form>
                </div>
