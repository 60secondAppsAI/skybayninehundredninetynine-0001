						...
						<td style="width: 100%;"></td>
				        	...
				        	<td style="width: 150px;">
								...
								<div >
								  ...
								  <base-input label="Name" type="text" placeholder="Enter Name" v-model="crewMemberToAdd.name"></base-input>
								  <base-input label="Position" type="text" placeholder="Enter Position" v-model="crewMemberToAdd.position"></base-input>
								  <base-input label="ContactNumber" type="text" placeholder="Enter ContactNumber" v-model="crewMemberToAdd.contactNumber"></base-input>
												                  </form>
								                </div>
            ...
            <div style="text-align: center; padding: 20px;">
              ...
              <button @click="handlePermissionDialogClose">OK</button>
					...
					<td class="detail_view_column_2">Name</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Name" type="text" placeholder="Enter Name" v-model="crewMemberDetails.name"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Position</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="Position" type="text" placeholder="Enter Position" v-model="crewMemberDetails.position"></input>
																		</div>
						</td>
														</tr>
															<tr> 
					<td class="detail_view_column_2">Contact Number</td>
										    <td class="detail_view_column_1">
							<div class="detail_view_input" style="display: inline-flex;">
																		<input label="ContactNumber" type="text" placeholder="Enter ContactNumber" v-model="crewMemberDetails.contactNumber"></input>
																		</div>
						</td>
														</tr>
